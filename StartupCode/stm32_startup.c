...
void ECTI15_10_Handler(void) __attribute__((weak, alias("Default_Handler")));
...
void HDMICEC_Handler(void) __attribute__((weak, alias("Default_Handler")));
